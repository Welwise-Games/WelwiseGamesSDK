...
{
    internal sealed class DebugAdvertisement : MonoBehaviour, IAdvertisement
    {
        private static DebugAdvertisement _instance;
        ...
        internal static DebugAdvertisement Create()
        {
            var gameObject = new GameObject("DebugAdvertisement");
            var comp = gameObject.AddComponent<DebugAdvertisement>();
            if (_instance != null)
            {
                Destroy(gameObject);
                return _instance;
